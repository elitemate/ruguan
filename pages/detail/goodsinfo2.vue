<template>
	<view class="s-page-wrapper">
		<view class="index-goods" v-if="loadGoods">
			...
			<!-- 发需求 发服务 active-->
<!-- 			<view v-if="shopCartBg" class="goods_shop_cart_bg" @tap="showShopCartBg('cart')" ></view> -->
			<view class="goods_share" v-bind:class="[shopCartBg ? 'active' : '','']">
				<view class="cent">
					<view class="itemwrap" style="">
						<view class="item" @tap="shareFc()" style="">
							<view class="title">
					...
					<text class="em"></text>
					<view class="itemwrap" style="">
						<view class="item" @tap="shopCartShare()" style="">
							<view class="title">
					...
					<text class="em"></text>
					<view class="itemwrap" style="">
						<view class="item_noshadow" @tap="shopCartShare()"  style="text-align:center ;color: #999999;font-size:16px;">	 
							取消
						</view>
					</view>
				</view>
			...
			<view class="goods_filter" v-bind:class="[filterButton ? 'active' : '','']">
				<view class="cent">
					
					<view class="titleLine">
						<text class="title" style="">一级分类</text>
		...
		<view class="goods-list" style="margin-bottom: 60px" v-if="couponlist.length > 0">
			<orange-goods-card-home v-for="(item,index) in couponlist" :index="index%2" :tkmoney='"￥"+item.tkmoney' :itemid="item.itemid"
			 :itempic="item.itempic?item.itempic+'_310x310.jpg':'../../static/img/avatar.png'" :itemtitle="item.itemtitle"
