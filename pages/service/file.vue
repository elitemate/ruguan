<template>
    ...
    <view class="index-content" style="background: #f4f5f6;margin-top:10upx;">
		<view class="toptab_item_wrap">
		     <view class="toptab_item"  :class="index==TabCur?'reeew':''" v-for="(item,index) in category"
		...
		<view class="message_item" style="">
			<view  class="avatar" style="">
				<image class="headImage" src="../../static/img/icon_file01.png"></image>
			</view>
		...
		<view class="message_item" style="">
			<view  class="avatar" style="">
				<image class="headImage" src="../../static/img/icon_file02.png"></image>
			</view>
			<view class="box-name title" style="">
					<text class="name" >
						我司文化背景
		...
		<view class="message_item" style="">
			<view  class="avatar" style="">
				<image class="headImage" src="../../static/img/icon_file03.png"></image>
			</view>
			<view class="box-name title" style="">
					<text class="name" >
						段视频策划二期
		...
		<view class="message_item" style="">
			<view  class="avatar" style="">
				<image class="headImage" src="../../static/img/icon_file04.png"></image>
			</view>
			<view class="box-name title" style="">
					<text class="name" >
						现有的图片资料
		...
		<view class="message_item" style="">
			<view  class="avatar" style="">
				<image class="headImage" src="../../static/img/icon_file05.png"></image>
			</view>
			<view class="box-name title" style="">
					<text class="name" >
						短视频策划理念方向
    ...
    export default {
        ...
        data() {
            return {
                ...
                category: [
                    {name: '雇主的附件', position: 1, total: 0, data: []},
                    {name: '交易合同', position: 2, total: 0, data: []},
					{name: '源文件', position: 3, total: 0, data: []},
					{name: '工作反馈记录', position: 4, total: 0, data: []},
				  ],
                news: [],
                newsLoad: {
                    loading: false,
