<template>
	...
	<view style="background:#f3f4f5;padding:16px;border-bottom: 1px solid #F6F6F6">
		...
		<!--消息-->
		<view style="display: flex;flex-direction: row;background: #ffffff;padding:15upx;">
			<view>
				<image class="headImage" src="../../static/img/message/avatar_message_05.png"></image>
			</view>
			<view class="box-name" style="display: flex;flex-direction: column;justify-content: flex-start;align-items: flex-start;align-content: flex-start;">
				...
				<view  style="color:#999;">精准测速拿，看看您的企业能拿多少政策补贴？立即测算>></view>
			</view>
		</view>
