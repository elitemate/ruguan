...
import orangeMessage from './components/uni-pro/orange-message'
import orangeDeal from './components/uni-pro/orange-deal'
import orangeFriend from './components/uni-pro/orange-friend'
import orangeComment from './components/uni-pro/orange-comment'
...
Vue.component('orange-friend', orangeFriend);
Vue.component('orange-message', orangeMessage);
Vue.component('orange-deal', orangeDeal);
Vue.component('orange-comment', orangeComment);
